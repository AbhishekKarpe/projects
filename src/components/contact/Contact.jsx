...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "3ff9fd3b-9f11-44d0-8dc6-937be7ec8c24");
  ...
  return (
    <div className='contact'>
      <div className='contact-col'>
        ...
        and suggestions are important to us as we strive to provide exceptional service to our university community.</p>
        <ul>
            <li><img src={mail_icon}/>Contact@GreatStack.dev</li>
            <li><img src={phone_icon}/>Contact@GreatStack.dev</li>
            <li><img src={location_icon}/>+1 123-456-7890</li>
